...
<img src="community-editor/dika-logo.svg" alt="dika studio" width="120">
</td>
<td>
...
<table>
  <tr>
    <td width="58%"><img src="community-editor/docs/img/studio-overview.png" alt="dika studio video editing workspace"></td>
    <td width="42%"><img src="community-editor/docs/img/editor-text-tools.png" alt="dika studio design editor and text tools"></td>
  </tr>
</table>
...
| **Any browser** | Clone or download this repository and open `community-editor/index.html` |
...
Open `community-editor/index.html`. The production bundle needs no build step, server or account. Projects save to
...
```bash
node community-editor/scripts/static-server.js 8300
```
...
`community-editor/index.dev.html` loads source modules separately so changes appear after reload.
Run it through the static server, then rebuild `community-editor/index.html` after editing anything
under `community-editor/modules/`:

```bash
node community-editor/tools/build-bundle.mjs
```

Before release, verify the Community Editor manifest:

```bash
node community-editor/tools/check-upstream-drift.mjs
```
...
[THIRD-PARTY-NOTICES.md](community-editor/THIRD-PARTY-NOTICES.md). dika studio names, logos and marks are governed by
